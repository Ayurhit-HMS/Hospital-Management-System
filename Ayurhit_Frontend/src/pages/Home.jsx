                            ...
                            <div className="col">
                                <ul className="nav nav-pills mb-5 d-flex justify-content-center" id="pills-tab" role="tablist">
                                    <li className="nav-item" role="presentation">
                                        <button className="nav-link active btn-success" data-bs-toggle="pill" data-bs-target="#pills-specialities" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Specialities</button>
                                    </li>
                                    <li className="nav-item" role="presentation">
